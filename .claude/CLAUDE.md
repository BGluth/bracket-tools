...
| bracket-tools-startgg-schema | crates/bracket-tools-startgg-schema | ~86% | cynic codegen types from start.gg schema |
| bracket-tools-startgg | crates/bracket-tools-startgg | ~83% | Main SDK: caching, rate-limited start.gg client |
...
| bracket-tools-scheduler | tools/scheduler | ~88% | Multi-bracket calling tool for the TO desk |
